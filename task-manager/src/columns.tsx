...
export function ComboboxPopover({ status, onStatusChange }: { status: string, onStatusChange: (newStatus: string) => void }) {
...
export const columns = (handleDelete: (id: number) => void, handleStatusChange: (id: number, newStatus: string) => void): ColumnDef<Task>[] => [
  {
    accessorKey: "status",
    header: "Status",
    cell: ({ row }) => (
